...
enum LegacyMigrationManager {
    ...
    static func disableInvisibleHelperIfNeeded() -> LegacyMigrationResult {
        ...
        let retained = home
            .appendingPathComponent("Library/Application Support/CodexMicro", isDirectory: true)
            .appendingPathComponent("Legacy", isDirectory: true)
        let executableMarker =
            "/Library/Application Support/CodexMicro/CodexBridge.app/Contents/MacOS/codexbridge"
