...
final class AppLogStore {
    ...
    private init() {
        directoryURL = FileManager.default.homeDirectoryForCurrentUser
            .appendingPathComponent("Library/Logs/AgentMicro", isDirectory: true)
        logURL = directoryURL.appendingPathComponent("agentmicro.log")
    ...
    private func rotateIfNeeded() {
        ...
        let previous = directoryURL.appendingPathComponent("agentmicro.previous.log")
