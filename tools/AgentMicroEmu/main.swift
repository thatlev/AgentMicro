...
//
// Build:  swiftc -O tools/AgentMicroEmu/main.swift -o tools/AgentMicroEmu/agentmicroemu
// Run:    ./tools/AgentMicroEmu/agentmicroemu
...
class Emu: NSObject, CBPeripheralManagerDelegate {
    ...
    func peripheralManager(_ p: CBPeripheralManager, didAdd service: CBService, error: Error?) {
        ...
        if service.uuid == CBUUID(string: "180A") {
            ...
            print("[ble] advertising as 'AgentMicro' (VID 303A PID 8360)")
        }
    }
