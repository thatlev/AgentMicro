...
// CodexMicro-only control channel (device→shim). Not part of the Codex Micro
...
function createBridge() {
  ...
  function handleFrame(tag, payload) {
    if (tag === T_PRESENCE) {
      ...
      // Intercept CodexMicro control frames before they reach the app.
  ...
  // the CodexMicro control channel: parse the JSON body and run the requested
