// AgentMicroVHid — virtual HID device (IOHIDUserDevice) emulating the Work Louder
// AgentMicro so ChatGPT Desktop's node-hid enumeration detects it exactly like
// real hardware (VID 0x303A / PID 0x8360 / usage page 0xFF00, report ID 6).
// Protocol reference: docs/agent-micro-protocol.md
//
// Build:  clang -fobjc-arc -framework Foundation -framework IOKit tools/AgentMicroVHid/main.m -o tools/AgentMicroVHid/vhid
// Run:    ./tools/AgentMicroVHid/vhid
...
- (BOOL)start {
    ...
    printf("[vhid] virtual device registered: Work Louder AgentMicro 303A:8360 usagePage=FF00\n");
    return YES;
}
