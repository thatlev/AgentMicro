...
// This file deliberately has no dependency on CodexMicroBridge's main.swift so
...
public final class T3KeychainCredentialStore: T3CredentialStoring, @unchecked Sendable {
    ...
    public init(service: String = "com.codexmicro.bridge.t3.bearer") {
...
private enum T3StableUUID {
    // Fixed namespace allocated only for CodexMicro's T3 command IDs.
...
public final class T3Backend: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.codexmicro.bridge.t3-backend")
